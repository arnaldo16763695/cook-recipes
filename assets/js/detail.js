...
fetchData(null, (data) => {
  ...
  const /** Array<string> */ tags = [...cuisineType, ...dietLabels, ...dishType];
     ...
     <figure class="detail-banner img-holder">
            ...
            <div class="detail content">
                <div class="title-wrapper">
                    ...
                    <button class="btn btn-secondary has-state has-icon ${isSaved ? "saved" : "removed"} onclick=saveRecipe(this, '
                    ${recipeId}')">
